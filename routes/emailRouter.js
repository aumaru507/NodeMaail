...
.post(cors.cors,(req,res,next)=>{
  ...
  */
  var transporter = nodemailer.createTransport({
    service: 'gmail',
    auth: {
      user: 'audeveloper507@gmail.com',//replace with your email
      pass: 'bjlbeahqytgzcwpo'//replace with your password
    }
  }); 
  ...
  */
  var mailOptions = {
    from: 'setthanan507@gmail.com',//replace with your email
    to: req.body.email,//replace with your email
    subject: `Contact from resume`,
    html: req.body.UserFirstName + req.body.UserLastName + "<br>"+
    req.body.UserEmail +"<br>"+ req.body.UserPhone +"<br>"+ req.body.UserMessage ,
